...
function Index12() {
  ...
  return (
    <div>
        {/* START HOME */}
        <section className="home-bg section home-half bg-dark" >
            <ReactPlayer width={1000} height={1000} className="test_full" url='https://youtu.be/AYmZaEVOIIs' loop={true} controls={false} muted={true} playing={true}/>
